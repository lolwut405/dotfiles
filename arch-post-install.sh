...
# Gnome
pacman -S --noconfirm gnome-shell gdm gnome-control-center gnome-tweaks ttf-croscore
pacman -S --noconfirm eog file-roller gedit gnome-terminal nautilus
pacman -S --noconfirm chrome-gnome-shell
systemctl enable gdm

# KDE
#pacman -S --noconfirm plasma-desktop breeze-gtk khotkeys kinfocenter kscreen plasma-pa plasma-nm sddm ttf-croscore
